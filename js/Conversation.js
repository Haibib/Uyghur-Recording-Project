...
function empDetails(xml) { 
    ...
    for(j = 1; j < metadata.childNodes.length-4; j+=2){
        metadataString += '<div class = metadataElement '+metadata.childNodes[j].tagName+'"><span class="metadataTitle">'+metadata.childNodes[j].tagName.substring(0, 1).toUpperCase()+metadata.childNodes[j].tagName.substring(1).replace("_", " ")+'</span>' + metadata.childNodes[j].innerHTML + '</div>';
    }
    metadataString += '<div class = "metadataSubtitle '+metadata.childNodes[j].tagName+'"> '+metadata.childNodes[j].tagName.substring(0, 1).toUpperCase()+metadata.childNodes[j].tagName.substring(1).replace("_", " ")+'</div>';
    //Speakers
    ...
    for(let s = 1; s < speakerSize; s+=2){
        ...
        metadataString += '<div class = "metadataElement '+metadataSubString.tagName+'"><span class="metadataTitle">'+metadataSubString.tagName.substring(0, 1).toUpperCase()+metadataSubString.tagName.substring(1).replace("_", " ")+'</span>' + '</div>';
        ...
        for(let p = 1; p < size; p+=2){
            ...
            metadataString += '<div class = "'+metadataSubSubString.tagName+' metadataElement"><span class="metadataTitle">'+metadataSubSubString.tagName.substring(0, 1).toUpperCase()+metadataSubSubString.tagName.substring(1).replace("_", " ")+'</span>' + metadataSubSubString.innerHTML + '</div>';
        }
    }
    j+=2;
    metadataString += '<div class = "metadataSubtitle '+metadata.childNodes[j].tagName+'"> '+metadata.childNodes[j].tagName.substring(0, 1).toUpperCase()+metadata.childNodes[j].tagName.substring(1).replace("_", " ")+'</div>';
    ...
    for(let p = 1; p < creatorSize; p+=2){
        ...
        metadataString += '<div class = "'+metadataSubString.tagName+' metadataElement"><span class="metadataTitle">'+metadataSubString.tagName.substring(0, 1).toUpperCase()+metadataSubString.tagName.substring(1).replace("_", " ")+'</span>' + metadataSubString.innerHTML + '</div>';
    }
